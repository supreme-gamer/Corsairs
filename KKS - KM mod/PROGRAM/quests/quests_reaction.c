...
void QuestComplete(string sQuestName, string qname)
{
	...
	{	
		...
		case "trade_quest_open":
            ...
            {
                attrName = ", что находится на " + XI_ConvertString(pchar.CargoQuest.iTradeIsland+"Voc"); // belamour
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "convoy_agreeded":
			...
			sTemp = XI_ConvertString("Colony" + pchar.quest.destination + "Gen") + ", что на " + XI_ConvertString(GetIslandByCityName(pchar.quest.destination) + "Voc") + ","; // belamour gen
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
		case "Shadow_inRoom":
			...
			LAi_SetImmortal(sld, false);
			iRank = sti(pchar.rank)+MOD_SKILL_ENEMY_RATE+1; // 240912

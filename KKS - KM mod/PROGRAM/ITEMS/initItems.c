...
//==================PATENTS
	...
	n = InitStdBlade(n, "blade_07", "ITEMS_16", 14, TGT_MARGINAL,   B_ORDINARY, "FencingH", 4, 1.00, 1.00, 1, 10, 1, 		  0); // Эсток (Риттершверт)
	...
	n = InitStdAmulet(n, "totem_01",  "Totem_1", "ITEMS_21",  3,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1, 		 "", 1); // Луженая глотка
	n = InitStdAmulet(n, "totem_02",  "Totem_2", "ITEMS_21",  8,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1, "boatswain", 1); // Спиногрыз
	n = InitStdAmulet(n, "totem_03",  "Totem_3", "ITEMS_21",  4,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1, 		 "", 1); // Бальзам Купидона
	n = InitStdAmulet(n, "totem_04",  "Totem_4", "ITEMS_21",  2,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,			 "", 1); // Клеврет
	n = InitStdAmulet(n, "totem_06",  "Totem_6", "ITEMS_21",  6,  rand(5000) + 10000, 0.5, 0.001, 1, 360, ITEM_TOTEM, 1, 1, 		 "", 1); // Гонтер			
	n = InitStdAmulet(n, "totem_05",  "Totem_5", "ITEMS_21",  9,  rand(5000) + 10000, 0.5, 0.001, 1, 360, ITEM_TOTEM, 1, 1, 		 "", 1); // Железный пуп	
	n = InitStdAmulet(n, "totem_07",  "Totem_7", "ITEMS_21", 14,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1, 		 "", 1); // Менестрель
	n = InitStdAmulet(n, "totem_08",  "Totem_8", "ITEMS_21", 13,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,  "cannoner", 1); // Повелитель огня
	n = InitStdAmulet(n, "totem_09",  "Totem_9", "ITEMS_21",  5,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1, "boatswain", 1); // Аргузин
	n = InitStdAmulet(n, "totem_10", "Totem_10", "ITEMS_21", 10,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,   "fighter", 1); // Творец вдов	
	n = InitStdAmulet(n, "totem_11", "Totem_11", "ITEMS_21", 11,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,	         "", 1); // Упырь	
	n = InitStdAmulet(n, "totem_12", "Totem_12", "ITEMS_21", 12,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,		     "", 1); // Сын ягуара
	n = InitStdAmulet(n, "totem_13", "Totem_13", "ITEMS_21",  7,  rand(5000) + 10000, 0.5, 0.001, 1,  360, ITEM_TOTEM, 1, 1,	         "", 1); // Джокер
	...
	n = InitStdAmulet(n, "indian_1", "pursel",    "ITEMS_3",  1,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 	   	     "", 0); //стрельба (1) (для всех)
	n = InitStdAmulet(n, "indian_2", "pursel",    "ITEMS_3",  2,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); //стрельба (2) (для всех)
	n = InitStdAmulet(n, "indian_3", "pursel",    "ITEMS_3",  3,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); // пробивающий удар (1) (для всех)
	n = InitStdAmulet(n, "indian_4", "pursel",    "ITEMS_3",  4,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); // пробивающий удар (2) (для всех)
	n = InitStdAmulet(n, "indian_5", "pursel",    "ITEMS_3",  5,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0,    "boatswain", 0); // абордаж (для боцмана)
	n = InitStdAmulet(n, "indian_6", "pursel",    "ITEMS_3",  6,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0,    "boatswain", 0); // мушкетный залп (1) (для боцмана)
	n = InitStdAmulet(n, "indian_7", "pursel",    "ITEMS_3",  7,   rand(150) + 100, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); // энергия (для всех)
	// красная группа без пенальти
	n = InitStdAmulet(n, "indian_8", "pursel",    "ITEMS_3",  8,   rand(100) +  50, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0,     "cannoner", 0); // меткость (1) (для канонира)
	n = InitStdAmulet(n, "indian_9", "pursel",    "ITEMS_3",  9,   rand(100) +  50, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0,     "cannoner", 0); // меткость (2) (для канонира)
	n = InitStdAmulet(n, "indian_10", "pursel",   "ITEMS_3", 10,   rand(100) +  50, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); // здоровье (1) (для всех)
	n = InitStdAmulet(n, "indian_11", "pursel",   "ITEMS_3", 11,   rand(100) +  50, 0.5, 0.01, 1, 120, ITEM_INDIAN, 0, 0, 			 "", 0); // скрытность (1) (для всех)
	
	// зеленая группа с пенальти (взаимоисключающая с красной)
	n = InitStdAmulet(n,     "amulet_1", "pursel",    "ITEMS_3", 12,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 			 "", 0); // Стрельба (3) (для всех)
	n = InitStdAmulet(n,     "amulet_2", "pursel",    "ITEMS_3", 13,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 			 "", 0); // Стрельба (4) (для всех)
	n = InitStdAmulet(n,     "amulet_3", "pursel",    "ITEMS_3", 14,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 			 "", 0); // Пробивающий удар (3) (для всех)
	n = InitStdAmulet(n,     "amulet_4", "pursel",    "ITEMS_3", 15,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 			 "", 0); // Пробивающий удар (4) (для всех)
	n = InitStdAmulet(n,     "amulet_5", "pursel",    "ITEMS_3", 16,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0,     "cannoner", 0); // Орудия (для канонира)
	n = InitStdAmulet(n,     "amulet_6", "pursel",   "ITEMS_20",  1,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 	 		 "", 0); // Здоровье (2) (для всех)
	n = InitStdAmulet(n,     "amulet_7", "pursel",   "ITEMS_20",  2,   rand(150) + 100, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0, 			 "", 0); // Здоровье (3) (для всех)
	// зеленая группа без пенальти
	n = InitStdAmulet(n,     "amulet_8", "pursel",   "ITEMS_20",  3,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0,    "carpenter", 0); // Защита (1) (для плотника)
	n = InitStdAmulet(n,     "amulet_9", "pursel",   "ITEMS_20",  4,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0,    "carpenter", 0); // Защита (2) (для плотника)
	n = InitStdAmulet(n,    "amulet_10", "pursel",   "ITEMS_20",  5,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0,       "doctor", 0); // Защита (3) (для врача)
	n = InitStdAmulet(n,    "amulet_11", "pursel",   "ITEMS_20",  6,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_AMULET, 0, 0,    "boatswain", 0); // Мушкетный залп (2) (для боцмана)
	
	// голубая группа 
	n = InitStdAmulet(n,     "obereg_1", "pursel",   "ITEMS_20",  7,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "carpenter", 0); // Починка (1) (для плотника)
	n = InitStdAmulet(n,     "obereg_2", "pursel",   "ITEMS_20",  8,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "carpenter", 0); // Починка (2) (для плотника)
	n = InitStdAmulet(n,     "obereg_3", "pursel",   "ITEMS_20",  9,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0, 			 "", 0); // Переносимый вес (для всех)
	n = InitStdAmulet(n,     "obereg_4", "pursel",   "ITEMS_20", 10,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0, 			 "", 0); // Скрытность (2) (для всех)
	n = InitStdAmulet(n,     "obereg_5", "pursel",   "ITEMS_20", 11,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0, 			 "", 0); // Везение (для всех)
	n = InitStdAmulet(n,     "obereg_6", "pursel",   "ITEMS_20", 12,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0, 			 "", 0); // Авторитет (для всех)
	n = InitStdAmulet(n,     "obereg_7", "pursel",   "ITEMS_20", 13,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,			 "", 0); // Навигация (для всех)
	n = InitStdAmulet(n,     "obereg_8", "pursel",   "ITEMS_20", 14,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0, 			 "", 0); // Торговля (для всех)
	n = InitStdAmulet(n,     "obereg_9", "pursel",   "ITEMS_20", 15,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "navigator", 0); // Скорость (1) (для штурмана)
	n = InitStdAmulet(n,    "obereg_10", "pursel",   "ITEMS_20", 16,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "navigator", 0); // Скорость (2) (для штурмана)
	n = InitStdAmulet(n,    "obereg_11", "pursel",   "ITEMS_21",  1,   rand(100) +  50, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "navigator", 0); // Скорость (3) (для штурмана)
	n = InitStdAmulet(n,   "rat_poison", "potion",    "ITEMS_6", 16,   rand(150) + 450, 0.5, 0.05, 1, 120, ITEM_OBEREG, 0, 0,    "treasurer", 0); // мышьяк (аналог крысобога)
...
//-----------ADDED BY VERRUCKT BROTHEL MOD------------------
	...
	n = InitStdItem( n,   "jewelry5",     "sapphire", "ITEMS_28",   5,   0.05,   1,   500,   5,  0.5,   ITEM_TRADE_JEWELRY); // золотой самородок
	n = InitStdItem( n,   "jewelry6",     "sapphire", "ITEMS_28",   9,   0.10,   0,   300,   3,  0.5,   ITEM_TRADE_JEWELRY); // серебряный самородок	
	n = InitStdItem( n,   "jewelry7",       "pursel", "ITEMS_28",   1, 0.0001,   1,  1300,  13,  0.1,   ITEM_TRADE_JEWELRY); // голубой янтарь
	...
	n = InitStdItem( n,  "jewelry10",       "pursel", "ITEMS_28",   6, 0.0001,   1,   800,   8,  0.5,   ITEM_TRADE_JEWELRY); // платиновый самородок
	n = InitStdItem( n,  "jewelry11",       "pursel", "ITEMS_28",   7, 0.0001,   1,   1500, 15,  1.1,   ITEM_TRADE_JEWELRY); // осколок метеорита
	n = InitStdItem( n,  "jewelry12",       "pursel", "ITEMS_28",   8, 0.0001,   1,   250,   3,  0.5,   ITEM_TRADE_JEWELRY); // медный самородок
					...
					int     Price)
{
	...
	{
		case "FencingL" :
			blade.Weight 	= 1.0 + fRandSmall(0.5); 
			MaxAttack		= FencingL_MaxAttack;
		break;
		case "FencingS" :
			blade.Weight 	= 2.0 + fRandSmall(0.5);
			MaxAttack		= FencingS_MaxAttack;			
		break;
		case "FencingH" :
			blade.Weight 	= 3.0 + fRandSmall(0.5); 
			MaxAttack		= FencingH_MaxAttack;
		break;
	}
	  switch (BladeType) // --> belamour нет секирам с нулевым балансом
	{ //// log_info("пошел выбор балланса11");
		case "FencingL" :
			blade.Balance 	= 0.1 + fRandSmall(0.6); 
		break;
		case "FencingS" :
			blade.Balance 	= 0.8 + fRandSmall(0.5);		
		break;
		case "FencingH" :
			blade.Balance 	= 1.4 + fRandSmall(0.6); 
		break;
	}
	//blade.Balance = fRandSmall(2.0); ЛЕСНИК.
	if(ModelID == "unarmed")
    {
        blade.Balance = 1.0;
	...
	{
		case B_POOR :
			blade.Attack 	= MaxAttack * (40.0 + fRandSmall(15.0))/100.0;			
			blade.rare 	 	= 0.1;
			blade.minlevel 	= 1;
...
void InitGuns()
{
    ...
    InitGunExt(      "pistol2", "t1",		 "grapeshot",      "gunpowder",  30.0,  80.0,  10.0,  50.0,  0.0,  0.0, 0, 1, 1, 0, 1, 0, 40, 40, 1);	
	InitGunExt(		 "pistol3", "t1", 	     "grapeshot",      "gunpowder",  40.0,  90.0,  15.0,  55.0,  0.0,  0.0, 0, 1, 1, 2, 1, 0, 40, 40, 1);	
	...
	InitGunExt(		 "pistol8", "t1", 	     "grapeshot",      "gunpowder",  25.0,  50.0,  15.0,  30.0,  5.0,  5.0, 1, 1, 1, 0, 1, 0, 50, 40, 1);	
	...
	InitGunExt(		"mushket3", "t1", 	     "grapeshot",      "gunpowder",  70.0, 120.0,  40.0,  90.0,  0.0,  0.0, 0, 1, 1, 0, 1, 0, 70, 25, 1);	
	InitGunExt("grape_mushket", "t1", 	       "grenade",               "", 100.0, 200.0,  80.0, 180.0, 10.0, 10.0, 1, 1, 1, 0, 1, 0,100, 50, 1);	
	InitGunExt("grape_mushket", "t2",    "powder_pellet",               "",  15.0, 115.0,   5.0, 105.0,100.0, 80.0, 1, 1, 1, 0, 1, 0,100, 50, 0);	
	...
	InitGunExt(		"mushket6", "t1", 	     "grapeshot",      "gunpowder",  90.0, 155.0,  50.0, 100.0, 20.0, 20.0, 1, 1, 1, 0, 0, 0, 70, 30, 1);	
	InitGunExt(		"mushket6", "t2", 	      "GunEchin",               "", 115.0, 180.0,  65.0, 115.0, 20.0, 20.0, 1, 1, 1, 0, 0, 0, 60, 25, 0);	
    ...
    InitGunExt(       "howdah", "t1",        "grapeshot",      "gunpowder",  25.0,  70.0,  15.0,  40.0,  5.0,  5.0, 1, 1, 1, 0, 0, 0, 50, 40, 1);		

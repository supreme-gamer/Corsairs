...
String GenerateItem(String _itemId)
{
	...
	{
		case "FencingL" :
			realItem.Balance    = 0.1 + fRandSmall(0.6);
			realItem.Weight 	= 1.0 + fRandSmall(0.5); 
			MaxAttack			= FencingL_MaxAttack;
		break;
		case "FencingS" :
			realItem.Balance    = 0.8 + fRandSmall(0.5);
			realItem.Weight 	= 2.0 + fRandSmall(0.5);
			MaxAttack			= FencingS_MaxAttack;			
		break;
		case "FencingH" :
			realItem.Balance    = 1.4 + fRandSmall(0.6); 
			realItem.Weight 	= 3.0 + fRandSmall(0.5); 
	...
	{
		case B_POOR :
			realItem.Attack 	= MaxAttack * (40.0 + fRandSmall(15.0))/100.0;			
		break;
		case B_ORDINARY :

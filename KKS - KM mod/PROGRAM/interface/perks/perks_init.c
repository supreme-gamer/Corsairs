...
void extrnInitPerks()
{
	...
	ChrPerksList.list.SeaDogProfessional.condition.GrapplingProfessional = true;
	ChrPerksList.list.SeaDogProfessional.condition.CannonProfessional = true;
	ChrPerksList.list.SeaDogProfessional.condition.ShipDefenseProfessional = true;

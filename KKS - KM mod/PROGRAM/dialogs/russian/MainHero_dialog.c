void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
			...
			Link.l1.go = "exit";
	/////////////////////////////////// хар-ки лесник ///////////////////////////////////
			if (CheckAttribute(pchar, "quest.start_monolog12"))
			{
				dialog.text = "Месье, поторопитесь!"; //Serj
				link.l1 = "Да-да, я уже иду."; //Serj
	...
	/////////////////////////////////// хар-ки лесник ///////////////////////////////////
    		...
    		{
    		    dialog.text = "Итак, сундук подготовлен. Буду складывать в него оружие для людей Жана Пикара. Сабли и топоры в нужном количестве возьмём из арсенала на корабле, а пистоли и мушкеты придётся собирать вручную по возможности: пистолей - 30, мушкетов - 2. К каждому пистолю нужен хотя бы 1 заряд, а к мушкету - 20, иначе от них не будет толку. Лечебных зелий желательно побольше, но свыше 3 штук на человека не имеет смысла. Приступаю к сбору!";
	...
	/////////////////////////////////// хар-ки лесник ///////////////////////////////////
		...
		case "Startsailor_6":
			DialogExit_Self();
			LAi_SetPlayerType(pchar);
			DeleteAttribute(pchar, "quest.start_monolog12");
			chrDisableReloadToLocation = false;

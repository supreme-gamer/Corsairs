...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Startsailor_5":
			...
			link.l1 = "Сейчас, погоди - дай соберусь с мыслями.";
			link.l1.go = "vibor_GG1";
		break;
		
		case "vibor_GG1":
			DialogExit();
			pchar.SystemInfo.ChangePIRATES = true; // лесник
			LaunchCharacter(pchar);
			DeleteAttribute(pchar, "quest.start_monolog1");
			LAi_SetPlayerType(pchar);
			pchar.quest.start_monolog12 = "true";
		...
		case "Folke_13":
			dialog.text = "Тогда я отправляюсь на своё место на палубе. Приказывайте отчаливать, капитан!";
			link.l1 = "...";
			link.l1.go = "Folke_14";
		break;
		...
		case "adrian_1":
			dialog.text = "Да, конечно. Вот то, что я привёз из Сантьяго специально для тебя. Здесь освящённые обереги и целебные отвары. И даже редкая, уникальная тинктура Ометочтли, улучшающая боевые качества. Это всё тебе, сын мой.";
			link.l1 = "Спасибо!";
			link.l1.go = "adrian_2";
		break;

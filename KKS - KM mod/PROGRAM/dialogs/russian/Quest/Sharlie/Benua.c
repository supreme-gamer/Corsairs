...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FastStart_4":
			...
			dialog.text = "Я не буду тебя торопить. Год - срок, более, чем достаточный.";
		...
		case "FastStart_6":
			...
			SetFunctionTimerCondition("Sharlie_BenuaLoanTime", 0, 0, 360, false);

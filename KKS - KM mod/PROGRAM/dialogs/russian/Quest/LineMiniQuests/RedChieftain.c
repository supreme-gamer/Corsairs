void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "RedChieftain_9":
			dialog.text = "Если бледнолицый брат возьмёт похожий каноэ, то можно незаметно подкрасться к ним - я видел как они торгуют с таким же каноэ иногда. Я показать дорогу. Но только на один такой каноэ, иначе бледнолицый собака увидеть и загнать индеец с лодка в джунгли...";
			link.l1 = "Ясно. Для этой операции нужен корабль того же ранга - в идеале, шхуна или военная шхуна. Хм. На одном корабле против двух... а, ладно, справимся как-нибудь!";

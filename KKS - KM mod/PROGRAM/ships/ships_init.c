void InitShips()
{
  ref refShip;
	...
	///////////////////////////////////////////////////////////////////////////
	//// Тяжелый Галеон (теперь - военный галеон)
	///////////////////////////////////////////////////////////////////////////
	...
	refShip.Capacity        			= 5000;
	refShip.CannonsQuantity				= 58;	// 6,4,23,23
	refShip.CannonsQuantityMin			= 58;
	refShip.rcannon 					= 26;
	refShip.lcannon 					= 26;
	refShip.fcannon 					= 6;
	...
	//// Линкор "Le Superbe"
	///////////////////////////////////////////////////////////////////////////
	makeref(refShip,ShipsTypes[SHIP_LESUPERBE]);
	refShip.Name            			= "LeSuperbe";
	refship.Soundtype					= "manowar";
	refShip.Class						= 1;
	refShip.Cannon          			= CANNON_TYPE_CANNON_LBS36;
	refShip.MaxCaliber      			= 42;
	refShip.Weight						= Tonnes2CWT(3300);
	...
	refship.InertiaAccelerationX		= 4.5;	refship.InertiaBrakingX		= 4.0;
	refship.InertiaAccelerationY		= 3.5;	refship.InertiaBrakingY		= 3.0;
	refship.InertiaAccelerationZ		= 4.5;	refship.InertiaBrakingZ		= 4.0;
	...
	//// Кеч "Несравненный"
	///////////////////////////////////////////////////////////////////////////
	makeref(refShip,ShipsTypes[SHIP_NONSUCH]);
	refShip.Name            			= "Nonsuch";
	refship.Soundtype					= "lugger";
	refShip.Class						= 5;
	refShip.Cannon          			= CANNON_TYPE_CANNON_LBS12;
	refShip.MaxCaliber      			= 12;
	refShip.Weight						= Tonnes2CWT(165);
	...
	refship.InertiaAccelerationX	= 6.5;	refship.InertiaBrakingX		= 6.5;
	refship.InertiaAccelerationY	= 6.5;	refship.InertiaBrakingY		= 6.5;
	refship.InertiaAccelerationZ	= 6.5;	refship.InertiaBrakingZ		= 6.5;
	...
	refship.Track1.LifeTime = 9;
	refship.Track1.Width	= "4.0, 5.0";
	refship.Track1.Speed	= "12.0, 20.0";

	refship.Track2.ZStart	= -0.15;
	refship.Track2.LifeTime = 7.5;
	refship.Track2.Width	= "5.0, 6.5";
	refship.Track2.Speed	= "0.15, 0.25";
	...
	refship.InertiaAccelerationX 		= 1.5;
	refship.InertiaAccelerationY 		= 1.5;
	refship.InertiaAccelerationZ 		= 1.5;
	refship.InertiaBrakingX 			= 1.5;
	refship.InertiaBrakingY 			= 1.5;
	refship.InertiaBrakingZ 			= 1.5;

	refShip.Height.Bombs.Y 				= 2.7;
	refShip.Height.Grapes.Y 			= 4.3;
	refShip.Height.Knippels.Y 			= 13.0;
	refShip.Height.Balls.Y 				= 2.7;
	refShip.Height.Bombs.DY 			= 1.3;
	refShip.Height.Grapes.DY 			= 2.1;
	refShip.Height.Knippels.DY 			= 11.7;
	refShip.Height.Balls.DY 			= 1.3;
	...
	refShip.SpeedRate       			= 14.0;
	refShip.TurnRate        			= 32.4;
	refShip.HP              			= 6000;
	refShip.Capacity        			= 4250;
	refShip.SP              			= 100;
	refShip.Price           			= 100800;
	...
	refship.InertiaAccelerationY 		= 2.5;
	refship.InertiaAccelerationZ 		= 3.0;
	refship.InertiaBrakingX 			= 3.0;
	refship.InertiaBrakingY 			= 2.5;
	refship.InertiaBrakingZ 			= 3.0;

	refShip.Height.Bombs.Y 				= 3.5;
	refShip.Height.Grapes.Y 			= 4.8;
	refShip.Height.Knippels.Y 			= 16.7;
	refShip.Height.Balls.Y 				= 3.5;
	refShip.Height.Bombs.DY 			= 1.7;
	refShip.Height.Grapes.DY 			= 2.4;
	refShip.Height.Knippels.DY 			= 12.8;
	refShip.Height.Balls.DY 			= 1.7;
	...
	refShip.CannonsQuantityMin			= 100;
	refShip.rcannon 					= 46;
	refShip.lcannon 					= 46;
	refShip.fcannon 					= 4;
	refShip.bcannon 					= 4;
	...
	refShip.SpeedRate       			= 13.0;
	refShip.TurnRate        			= 26.5;
	refShip.HP              			= 10000;
	refShip.Capacity        			= 9800;
	refShip.SP              			= 100;
	...
	refship.InertiaAccelerationY 		= 2.5;
	refship.InertiaAccelerationZ 		= 3.5;
	refship.InertiaBrakingX 			= 3.0;
	refship.InertiaBrakingY 			= 2.5;
	refship.InertiaBrakingZ 			= 3.0;

	refShip.Height.Bombs.Y 				= 4.3;
	refShip.Height.Grapes.Y 			= 5.6;
	refShip.Height.Knippels.Y 			= 18.7;
	refShip.Height.Balls.Y 				= 4.3;
	refShip.Height.Bombs.DY 			= 2.1;
	refShip.Height.Grapes.DY 			= 2.8;
	refShip.Height.Knippels.DY 			= 12.7;
	refShip.Height.Balls.DY 			= 2.1;

void InitGoods()
{
	...
	Goods[GOOD_BALLS].Cost					= 10;
	Goods[GOOD_BALLS].Weight				= 2;
	Goods[GOOD_BALLS].Units					= 50;
	Goods[GOOD_BALLS].SpeedV0				= 1.0;
	Goods[GOOD_BALLS].DamageHull			= 0.75;
	...
	Goods[GOOD_BALLS].Norm					= 10000;
	Goods[GOOD_BALLS].MediumNorm			= 0.5;
	Goods[GOOD_BALLS].SmallNorm				= 0.3;
	
	Goods[GOOD_GRAPES].Name					= "Grapes";
	Goods[GOOD_GRAPES].Cost					= 10;
	Goods[GOOD_GRAPES].Weight				= 1;
	Goods[GOOD_GRAPES].Units				= 50;
	...
	Goods[GOOD_RUM].Cost		    		= 30;
	Goods[GOOD_RUM].Units		    		= 3;
	...
	Goods[GOOD_CANNON_3].SmallNorm			= 0.5;
	...
	Goods[GOOD_CANNON_6].SmallNorm			= 0.5;
	...
	Goods[GOOD_CANNON_12].Norm          	= 35; 
	Goods[GOOD_CANNON_12].MediumNorm		= 0.7;
	Goods[GOOD_CANNON_12].SmallNorm			= 0.4;
	...
	Goods[GOOD_CANNON_16].MediumNorm		= 0.7;
	Goods[GOOD_CANNON_16].SmallNorm			= 0.4;
	...
	Goods[GOOD_CANNON_20].Norm          	= 50; 
	Goods[GOOD_CANNON_20].MediumNorm		= 0.7;
	Goods[GOOD_CANNON_20].SmallNorm			= 0.4;
	...
	Goods[GOOD_CANNON_24].Norm          	= 35; 
	Goods[GOOD_CANNON_24].MediumNorm		= 0.7;
	Goods[GOOD_CANNON_24].SmallNorm			= 0.4;
	...
	Goods[GOOD_CANNON_32].MediumNorm		= 0.75;
	Goods[GOOD_CANNON_32].SmallNorm			= 0.5;
	...
	Goods[GOOD_CANNON_36].Norm          	= 12; 
	Goods[GOOD_CANNON_36].MediumNorm		= 0.8;
	Goods[GOOD_CANNON_36].SmallNorm			= 0.8;
	...
	Goods[GOOD_CANNON_42].MediumNorm		= 0.8;
	Goods[GOOD_CANNON_42].SmallNorm			= 0.6;
	...
	Goods[GOOD_CULVERINE_8].Norm          	= 35; 
	Goods[GOOD_CULVERINE_8].MediumNorm		= 0.8;
	Goods[GOOD_CULVERINE_8].SmallNorm		= 0.6;
	...
	Goods[GOOD_CULVERINE_18].MediumNorm		= 0.8;
	Goods[GOOD_CULVERINE_18].SmallNorm		= 0.6;
	...
	Goods[GOOD_CULVERINE_36].MediumNorm		= 0.8;
	Goods[GOOD_CULVERINE_36].SmallNorm		= 0.6;

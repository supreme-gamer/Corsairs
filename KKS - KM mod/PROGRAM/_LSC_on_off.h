...
#define VERSION_NUMBER1       "ККС (v1.7.3 х64)" // Корсары: КС modding base #1
#define VERSION_NUMBER2       " + Granevek АнтиХардкор Патч v0.1"
...
int    startHeroType 	= 1;
int    MaxHeroQty		= 8;  // максимальное кол-во ГГ
int    MaxPGGQty		= 20; // максимальное кол-во ПГГ (+2 оставшихся ГГ)
//int    heroFaceId    = 1;
// boal 23.01.2004 <--

...
void GiveItemToTrader(aref ch)
{
	...
	if (bBettaTestMode || csmCA(pchar, "CSM.AllItemsInTrade")) // --> CSM
	{
    	for(i = 0; i < ITEMS_QUANTITY; i++)
    	{
			itm = &Items[i];

			if (csmCA(itm, "ItemType") && itm.ItemType == "QUESTITEMS")
				continue;
		...
		// --[ CSM
		csmTIM(ch, "suit2,suit3,unarmed,blade_34,blade_35,pistol10,pistol11,underwater", "");
	...
	switch (merType)
	{
		case "potion" 		: // лекарства и травы + обереги
			...
			{
				AddItems(ch,"potion2", Rand(5) + 5);
				AddItems(ch,"mineral27", 1);
				AddItems(ch, "potion3", Rand(5) + 10);
				AddItems(ch, "potion4", Rand(5) + 10);
				AddItems(ch, "potion5", Rand(5) + 10);
				AddItems(ch,"potionrum", Rand(3) + 2);
				 // пропишем тетра-гидро-каннабинолы :)
				AddItems(ch, "cannabis1", Rand(15) + 1);
				AddItems(ch, "cannabis2", Rand(15) + 1);
				AddItems(ch, "cannabis3", Rand(15) + 1);
				AddItems(ch, "cannabis4", Rand(15) + 1);
				AddItems(ch, "cannabis5", Rand(15) + 1);
				AddItems(ch, "cannabis6", Rand(15) + 1);
			}
			// рецепты
			irand = drand(160); // 5% вероятности
			...
			if(irand == 30 ) AddItems(ch, "recipe_totem_01", 1);
			if(irand == 40 ) AddItems(ch, "recipe_totem_02", 1);
			if(irand == 50 ) AddItems(ch, "recipe_totem_03", 1);
			if(irand == 60) AddItems(ch, "recipe_totem_04", 1);
			if(irand == 70 ) AddItems(ch, "recipe_totem_05", 1);
			if(irand == 80 ) AddItems(ch, "recipe_totem_06", 1);
			if(irand == 90 ) AddItems(ch, "recipe_totem_07", 1);
			if(irand == 100 ) AddItems(ch, "recipe_totem_08", 1);
			if(irand == 110 ) AddItems(ch, "recipe_totem_09", 1);
			if(irand == 120 ) AddItems(ch, "recipe_totem_10", 1);
			if(irand == 130 ) AddItems(ch, "recipe_totem_11", 1);
			if(irand == 140 ) AddItems(ch, "recipe_totem_12", 1);
			if(irand == 150 ) AddItems(ch, "recipe_totem_13", 1);
		break;
		
		case "veteran" 		: // скобяные изделия
			AddItems(ch, "mineral1", 	Rand(3) + 2);	
			AddItems(ch, "mineral2", 	Rand(4) + 1);	
			AddItems(ch, "mineral3", 	Rand(4) + 5);
			AddItems(ch, "mineral5", 	Rand(10) + 1);
			AddItems(ch, "mineral6", 	Rand(10) + 1);
			AddItems(ch, "mineral7", 	Rand(10) + 1);				
			AddItems(ch, "mineral9", 	Rand(10) + 1);
			AddItems(ch, "mineral10", 	Rand(10) + 1);
			AddItems(ch, "mineral13", 	Rand(10) + 1);		
			AddItems(ch, "mineral15", 	Rand(10) + 1);
			AddItems(ch, "mineral16", 	Rand(10) + 1);
			AddItems(ch, "mineral18", 	Rand(10) + 1);
			AddItems(ch, "mineral19", 	Rand(10) + 1);
			AddItems(ch, "mineral20", 	Rand(10) + 1);
			AddItems(ch, "mineral21", 	Rand(10) + 1);
			AddItems(ch, "mineral22", 	Rand(10) + 1);
			AddItems(ch, "mineral23", 	Rand(10) + 1);
			AddItems(ch, "mineral24", 	Rand(10) + 1);
			AddItems(ch, "mineral25", 	Rand(10) + 1);
			AddItems(ch, "mineral26", 	Rand(10) + 1);
			AddItems(ch, "mineral33", 	Rand(10) + 1);
			AddItems(ch, "mineral35", 	Rand(10) + 1);
			// амулеты
			irand = drand(3); 
			if(irand == 1) AddItems(ch, "obereg_5", 1);
			if(irand == 2) AddItems(ch, "obereg_4", 1);
			if(irand == 3) AddItems(ch, "obereg_3", 1);
		break;
		
		case "armourer": // оружие и боеприпасы
			AddItems(ch, "bullet", 		Rand(30) + 10);	
			AddItems(ch, "grapeshot", 	Rand(30) + 10);    
			AddItems(ch, "gunpowder", 	Rand(30) + 10); // Warship. Порох
			// трубы
			irand = drand(2);
			...
			GenerateAndAddItems(ch, "topor_02", 1);
			if(rank >= 5)
			{
				GenerateAndAddItems(ch, "blade_03", 1);
				GenerateAndAddItems(ch, "blade_05", 1);
				GenerateAndAddItems(ch, "blade_07", 1);
				GenerateAndAddItems(ch, "blade_08", 1);
				GenerateAndAddItems(ch, "blade_09", 1);
			}
			// кирасы
			AddItems(ch, "cirass5", 1);
			
			irand = drand(1);
			if (irand == 1 && rank >= 6) 	AddItems(ch, "cirass1", 1);
			irand = drand(2);
			if (irand == 2 && rank >= 10) 	AddItems(ch, "cirass6", 1);
			irand = drand(3);
			if (irand == 3 && rank >= 12) 	AddItems(ch, "cirass2", 1);
			irand = drand(1);
			if (irand == 0 && rank >= 15) 	AddItems(ch, "cirass7", 1);
			irand = drand(4);
			if (irand == 4 && rank >= 18) 	AddItems(ch, "cirass3", 1);	
						
			if(rank >= 7)
			{
				irand = drand(3);
				if(irand == 1) GenerateAndAddItems(ch, "blade_11", 1);
				if(irand == 2) GenerateAndAddItems(ch, "blade_12", 1);
				if(irand == 3) GenerateAndAddItems(ch, "blade_14", 1);
			}
			// хорошие сабельки
			if(rank >= 10)
			{
				...
				if(irand == 2) GenerateAndAddItems(ch, "blade_04", 1);
				if(irand == 3) GenerateAndAddItems(ch, "blade_06", 1);
				if(irand == 4) GenerateAndAddItems(ch, "blade_10", 1);
				if(irand == 5) GenerateAndAddItems(ch, "blade_13", 1);
			}
			// приборы
			irand = drand(4);
			if(irand == 1 && rank >=5) AddItems(ch, "compass1", 1);
			if(irand == 2 && rank >=5) AddItems(ch, "sand_clock", 1);
			if(irand == 3 && rank >=7) AddItems(ch, "astrolab", 1);
			if(irand == 4 && rank >=7) AddItems(ch, "clock1", 1);
			// рецепты
			irand = drand(30); // 5% вероятности
			if(irand == 10 ) AddItems(ch, "recipe_powder_pellet", 1);
			if(irand == 20 ) AddItems(ch, "recipe_grenade", 1);
			if(irand == 30 ) AddItems(ch, "recipe_harpoon", 1);
			// амулеты
			irand = drand(3); 
			if(irand == 1) AddItems(ch, "obereg_1", 1);
			if(irand == 2) AddItems(ch, "obereg_2", 1);
			if(irand == 3) AddItems(ch, "obereg_6", 1);
			irand = drand(3);
			if(irand == 1) AddItems(ch, "Mineral15", drand(2)+1);
			if(irand == 2) AddItems(ch, "Mineral13", drand(2)+1);
			if(irand == 3) AddItems(ch, "Mineral30", drand(5)+1);
		break;

		case "monk" 		: //  амулеты+всякая мурня, карты убрал
			AddItems(ch, "Mineral3", drand(5)+1); // свечи всегда
			// прочие предметы
			AddItems(ch, "Mineral5", drand(3));
			AddItems(ch, "Mineral11", drand(3));
			AddItems(ch, "Mineral21", drand(3));
			AddItems(ch, "Mineral1", drand(3));
			AddItems(ch, "potionwine", Rand(5) + 1);
			AddItems(ch, "jewelry45", Rand(10) + 1);
			AddItems(ch, "jewelry48", Rand(10) + 1);
			AddItems(ch, "jewelry46", Rand(10) + 1);
			AddItems(ch, "jewelry43", Rand(10) + 1);
			AddItems(ch, "jewelry41", Rand(10) + 1);
			AddItems(ch, "jewelry40", Rand(10) + 1);
			irand = drand(3);
			...
			if(irand == 2) AddItems(ch, "amulet_3", 1);
			if(irand == 3) AddItems(ch, "amulet_6", 1);
			if(irand == 4) AddItems(ch, "amulet_7", 1);
			if(irand == 5) AddItems(ch, "amulet_8", 1);
			if(irand == 6) AddItems(ch, "amulet_9", 1);
			if(irand == 7) AddItems(ch, "amulet_10", 1);
			irand = drand(4);
			if(irand == 1) AddItems(ch, "obereg_11", 1);
			if(irand == 2) AddItems(ch, "obereg_8", 1);
			if(irand == 3) AddItems(ch, "obereg_10", 1);
			if(irand == 4) AddItems(ch, "obereg_7", 1);
			// рецепты
			irand = drand(15); // 5% вероятности
			if(irand == 5 ) AddItems(ch, "recipe_potion2", 1);
			if(irand == 10 ) AddItems(ch, "recipe_potion3", 1);
			if(irand == 15 ) AddItems(ch, "recipe_berserker_potion", 1);
		...
		case "indian" 		: // индейские артефакты
			...
			AddItems(ch, "mineral31", 1);				
			AddItems(ch, "mineral14", 1);		
			AddItems(ch, "mineral33", 1);
			
			irand = drand(11);
			if(irand == 1) AddItems(ch, "indian_1", 1);
			if(irand == 2) AddItems(ch, "indian_2", 1);
			if(irand == 3) AddItems(ch, "indian_3", 1);
			if(irand == 4) AddItems(ch, "indian_4", 1);
			if(irand == 5) AddItems(ch, "indian_5", 1);
			if(irand == 6) AddItems(ch, "indian_6", 1);
			if(irand == 7) AddItems(ch, "indian_7", 1);
			if(irand == 8) AddItems(ch, "indian_8", 1);
			if(irand == 9) AddItems(ch, "indian_9", 1);
			if(irand == 10) AddItems(ch, "indian_10", 1);
			if(irand == 11) AddItems(ch, "indian_11", 1);
		break;
		...
		case "jeweller" 	:// ювелир
			...
			AddItems(ch, "jewelry1",  Rand(30) + 10);
			AddItems(ch, "jewelry2",  Rand(30) + 10);
			AddItems(ch, "jewelry3",  Rand(30) + 10);
			AddItems(ch, "jewelry4",  Rand(30) + 10);
			AddItems(ch, "jewelry5",  Rand(30) + 10);
			AddItems(ch, "jewelry6",  Rand(30) + 10);
			AddItems(ch, "jewelry7",  Rand(10) + 1);
			AddItems(ch, "jewelry8",  Rand(30) + 10);
			AddItems(ch, "jewelry9",  Rand(30) + 10);
			AddItems(ch, "jewelry10", Rand(30) + 10);
			AddItems(ch, "jewelry11", Rand(3) + 1);
			AddItems(ch, "jewelry12", Rand(30) + 10);;
			AddItems(ch, "jewelry13", Rand(30) + 10);
			AddItems(ch, "jewelry14", Rand(30) + 10);;
			AddItems(ch, "jewelry15", Rand(30) + 10);
			AddItems(ch, "jewelry16", Rand(30) + 10);
			AddItems(ch, "jewelry17", Rand(30) + 10);
			AddItems(ch, "jewelry18", Rand(30) + 10);
			AddItems(ch, "jewelry19", Rand(30) + 10);
			AddItems(ch, "jewelry20", Rand(30) + 10);
			AddItems(ch, "jewelry21", Rand(30) + 10);
			AddItems(ch, "jewelry22", Rand(30) + 10);
			AddItems(ch, "jewelry23", Rand(30) + 10);
		break;
		...
		case "lightman": //Jason - смотрители маяков
			...
			if(irand == 2) AddItems(ch, "amulet_2", 1);
			if(irand == 3) AddItems(ch, "amulet_3", 1);
			if(irand == 4) AddItems(ch, "amulet_4", 1);
			if(irand == 5) AddItems(ch, "amulet_5", 1);
			if(irand == 6) AddItems(ch, "amulet_6", 1);
			if(irand == 7) AddItems(ch, "amulet_7", 1);
			if(irand == 8) AddItems(ch, "amulet_8", 1);
			if(irand == 9) AddItems(ch, "amulet_9", 1);
			if(irand == 10) AddItems(ch, "amulet_10", 1);
			if(irand == 11) AddItems(ch, "amulet_11", 1);
			irand = drand(12);
			if(irand == 1) AddItems(ch, "obereg_1", 1);
			if(irand == 2) AddItems(ch, "obereg_2", 1);
			if(irand == 3) AddItems(ch, "obereg_3", 1);
			if(irand == 4) AddItems(ch, "obereg_4", 1);
			if(irand == 5) AddItems(ch, "obereg_5", 1);
			if(irand == 6) AddItems(ch, "obereg_6", 1);
			if(irand == 7) AddItems(ch, "obereg_7", 1);
			if(irand == 8) AddItems(ch, "obereg_8", 1);
			if(irand == 9) AddItems(ch, "obereg_9", 1);
			if(irand == 10) AddItems(ch, "obereg_10", 1);
			if(irand == 11) AddItems(ch, "obereg_11", 1);
			if(irand == 12) AddItems(ch, "rat_poison", 1);
			irand = drand(15);
			if(irand == 5 && rank > 6) GenerateAndAddItems(ch, "blade_06", 1);
			if(irand == 10 && rank > 6) GenerateAndAddItems(ch, "blade_10", 1);
			if(irand == 15 && rank > 6) GenerateAndAddItems(ch, "blade_15", 1);
			irand = drand(15); // 170912
			if(irand == 3 && rank > 15) GenerateAndAddItems(ch, "blade_17", 1);
			if(irand == 6 && rank > 15) GenerateAndAddItems(ch, "blade_19", 1);
			if(irand == 9 && rank > 15) GenerateAndAddItems(ch, "blade_21", 1);
		break;
		...
		case "minentown": //Jason - торговец на золотом руднике
			...
			AddItems(ch, "jewelry10", dRand(7)+3));
			AddItems(ch, "jewelry14", 1+rand(4));
			AddItems(ch, "jewelry18", 1+rand(4));
			AddItems(ch, "jewelry13", dRand(5)+3));
			AddItems(ch, "jewelry16", 1+rand(4));
			AddItems(ch, "jewelry20", 1+rand(4));
			AddItems(ch, "jewelry12", dRand(5)+3));
			AddItems(ch, "jewelry17", 1+rand(4));
			AddItems(ch, "jewelry21", 1+rand(4));
			AddItems(ch, "jewelry15", 1+rand(4));
			AddItems(ch, "jewelry22", 1+rand(4));
			AddItems(ch, "jewelry23", 1+rand(4));
			AddItems(ch, "jewelry1", 1+rand(15));
			AddItems(ch, "jewelry2", 1+rand(15));
			AddItems(ch, "jewelry3", 1+rand(15));
			AddItems(ch, "jewelry4", 1+rand(15));
			AddItems(ch, "jewelry9", 1);
		break;
		...
		case "LSC_trader": //Jason - торговец в LSC. Всегда есть: лечилки, пули, порох, картечь. Остальное - как рандом ляжет. Могут быть старшие лечилки, амулеты, группа jewelry, ХО и ОО, доспехи.
			...
			irand = drand(4);
			if(irand == 1) AddItems(ch, "jewelry45", rand(2));
			if(irand == 2) AddItems(ch, "jewelry46", rand(2));
			if(irand == 3) AddItems(ch, "jewelry52", rand(5));
			if(irand == 4) AddItems(ch, "jewelry53", rand(7));
		break;
		...
		case "company": //Jason: главный клерк ГВИК: приборы, часы, карты, подзорные трубы
			...
			AddItems(ch, "clock1", 1);  // хронометр 33%
			AddItems(ch, "compass1", 1);  // компас 25%
			AddItems(ch, "astrolab", 1);  // астролябия 10%
			AddItems(ch, "spyglass2", 1);
			AddItems(ch, "spyglass3", 1);
			irand = drand(10);
			if(irand == 1 && sti(pchar.rank) > 10) AddItems(ch, "spyglass4", 1);
			GenerateMaps(ch, 20, 50); // patch-5
		break;
		
		case "cemeteryman": //Jason: смотрители кладбищ
			
			AddItems(ch, "cannabis1", 10+(rand(25)));
			AddItems(ch, "cannabis2", 10+(rand(25)));
			AddItems(ch, "cannabis3", 10+(rand(25)));
			AddItems(ch, "cannabis4", 10+(rand(25)));
			AddItems(ch, "cannabis5", 10+(rand(25)));
			AddItems(ch, "cannabis6", 10+(rand(25)));
			
			AddItems(ch, "jewelry12", 3+(rand(5)));
			AddItems(ch, "jewelry13", 3+(rand(5)));
			AddItems(ch, "jewelry22", 3+(rand(5)));
			
			AddItems(ch, "blade_03", 1);
			AddItems(ch, "blade_05", 1);
			AddItems(ch, "blade_07", 1);
			
			irand = drand(3);
			if(irand == 1) AddItems(ch, "blade_04", 1);
			if(irand == 2) AddItems(ch, "blade_06", 1);
			if(irand == 3) AddItems(ch, "blade_10", 1);
			
			AddItems(ch, "pistol1", 1);
			AddItems(ch, "bullet", 10+(rand(10)));
			AddItems(ch, "grapeshot", 10+(rand(10)));
			AddItems(ch, "cartridge", 10+(rand(10)));
			AddItems(ch, "gunpowder", 10+(rand(10)));
